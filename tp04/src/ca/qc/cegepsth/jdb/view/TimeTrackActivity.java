...
public class TimeTrackActivity extends Activity {
	...
	/*
	 * Types d'evenements Type 0 = Undefined Event Type (or RAW) Type 1 =
	 * PunchIn Type 2 = PunchOut Event Type 3 = Comment Or Note Event Type 4 =
	 * other
	 */
	...
	public void PunchIn(View view) {
		...
		MainActivity.jdb.saveToDevice(this); // Enregistre la liste sur
												// l'apareil
		this.Toaster("Vous venez de puncher In"); // On affiche � l'utilisateur
													// qu'il a puncher In
	...
	public void PunchOut(View view) {
		...
		MainActivity.jdb.saveToDevice(this); // Enregistre la liste sur
												// l'appareil
		this.Toaster("Vous venez de puncher Out"); // On affiche � l'utilisateur
													// qu'il a puncher
		this.setBTstatus(); // Appel la d�sactivation des boutons
		try {
	 ...
	 * 
	 *         Active ou d�sactive les boutons Commencer et Arreter, en fonction
	 *         de si on a punch� ou non.
	 */
