...
public class WriteLogActivity extends Activity {
	 ...
	 * @author Charles Perreault
	 * 
	 *         Ajoute une note dans le journal de bord et affiche un toast avec
	 *         le nombre d'evenements
	 */
	public void addNote(View view) {
		mEdit = (EditText) findViewById(R.id.wl_tb_text);
		/*
		 * Type 0 = Undefined Event Type (or RAW) Type 1 = PunchIn Event Type 2
		 * = PunchOut Event Type 3 = Comment Or Note Event Type 4 = other
		 */

		MainActivity.jdb.newEvent(3, mEdit.getText().toString()); // Ajoute un
																	// élément
																	// de Type 3
																	// au
																	// Journal
